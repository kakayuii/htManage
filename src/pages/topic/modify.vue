    ...
    <el-card>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="话题内容" prop="topicContent">
          <editor ref="editor" class="editor" :msg="form.topicContent"></editor>
        </el-form-item>
...
<script>
  ...
  export default class TopicAdd extends BaseComponent {
    ...
    async getDate(id){
      let res = await API.topic.getTopic(id);
      this.taboptions = res.tabList;
      ...
      this.form = {
        ...
        brief: res.brief,
        releaseFlag: res.releaseFlag,
        stickFlag: res.stickFlag,
        tabId:res.tabId,

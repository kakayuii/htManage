...
//          this.form.gwRegistrationProperty.id = this.form.id;
//          this.form.gwRegistrationProperty.activityId = this.form.id;
    ...
    async getDate(id) {
      ...
      let {age, email, company, mobile, name, position, sex,activityId} = res.data2;
      this.form = {
        ...
        tab_id: tab_id,
        gwRegistrationProperty: {age, company, email, mobile, name, position, sex,activityId,id:res.data2.id}
      }
    }
  }
</script>

...
<script>
  ...
  @Component
  export default class LoveDomainAdd extends BaseComponent {
    /*
    * 表单信息初始化
    * */
    form =  {
    ...
    rules =  {
      ...
      addressX: [
        { validator: this.validateX , message: '经度整数部分为0-180,小数部分为0到6位!', trigger: 'blur' }
      ],
      addressY: [
        { validator: this.validateY, message: '纬度整数部分为0-90,小数部分为0到6位', trigger: 'blur' }
      ],
      telephone: [
        { validator: this.validatePhone, trigger: 'blur' }
      ],
      tagOne: [
        { validator: this.validateSpace, message: '标签不能输入空格', trigger: 'blur' }
      ],
      tagTwo: [
        { validator: this.validateSpace, message: '标签不能输入空格', trigger: 'blur' }
      ],
